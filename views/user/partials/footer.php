    ...
    <div class="footer-content">
        ...
        <div class="footer-col">
            ...
            <div class="social-links">
                ...
                <a href="#" class="social-btn">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-3.78-1.54c-2.5 0-4.53 2.04-4.53 4.54 0 0.39 0.04 0.78 0.12 1.15-3.77-0.2-7.12-2-9.36-4.87a4.48 4.48 0 0 0-.6 2.27c0 1.57 0.8 2.95 2 3.76-0.74-0.02-1.44-0.23-2.05-0.57v0.06c0 2.2 1.56 4.03 3.64 4.44-0.38 0.1-0.78 0.16-1.2 0.16-0.29 0-0.58-0.02-0.86-0.08 0.58 1.8 2.26 3.11 4.25 3.15-1.55 1.21-3.5 1.93-5.62 1.93-0.36 0-0.72-0.02-1.07-0.05 2 1.29 4.39 2.04 6.94 2.04 8.32 0 12.87-6.9 12.87-12.87 0-0.2 0-0.39-0.03-0.59 0.88-0.64 1.65-1.44 2.25-2.36z"></path>
                    </svg>
                </a>
                <a href="#" class="social-btn">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="footer-col">
            <h4>Phim</h4>
            <ul>
                <li><a href="index.php?page=movies">Phim đang chiếu</a></li>
                <li><a href="index.php?page=movies">Phim sắp chiếu</a></li>
        ...
        <div class="footer-col">
            <h4>Rạp chiếu</h4>
            <ul>
                <li><a href="index.php?page=theaters">Tất cả rạp</a></li>
